...
- `git clone https://github.com/Kaweesi-Matia/school-library_OOP.git` if your're using https or git 
- `git@github.com:Kaweesi-Matia/school-library_OOP.git` if you prefer ssh and hit enter.
